        ...
        <div className="container sm:text-left md:text-center mx-auto my-page">
            <div className={`text-left ${styles.parent}`}>
                ...
                <div className={`text-left ${styles.caseStudyRight}`}>
                    ...
                    <p>
                    HOTG.ai required a solution for creating a container with universal execution, out-of-the-box sandboxing and security, and the ability to interface with low-level hardware. Their team tried several solutions like Emscripten and LLVM. However, they found the tight coupling between Emscripten and browsers a non-starter to their edge deployment needs. Ultimately, the team at HOTG.ai selected the Wasmer runtime for edge execution for WebAssembly.
                    </p><br></br>
                </div>
                <div class={`text-left ${styles.caseStudyBottom}`}>
                    <h3>Why Wasmer</h3><br></br>
                    <p>
                    HOTG.ai carefully considered different interpreters and runtimes as options for running server-side WebAssembly. Interpreters presented a larger payload for smaller IoT devices, and the team found them challenging to work with and extend. Wasmer provided HOTG.ai with a lightweight runtime and multiple compilation options. Tooling to precompile WebAssembly to architecture-specific formats enables HOTG.ai to write once and deploy anywhere without any runtime overhead. Additional applications like WAPM, Wasmer's WebAssembly Package manager help HOTG.ai realize its open-source community-driven mission for Tiny ML.
                    </p><br></br>
                    <p>
                        <div className={`${styles.quote}`}>"A really nice feature of Wasmer is that the SDK/API is very well designed and easy to use."<span className={`${styles.important}`}>&nbsp;&nbsp;- Kartik Thakore, Co-Founder at HOTG.ai.</span></div>
                    </p><br></br>
                ...
                <p>
                    <span className={`${styles.important}`}>Our mission is to connect the unconnected.</span>We are committed to the open-source community and strive to contribute to developers and companies worldwide to help make Wasmer and WebAssembly a universal standard.
                </p><br></br>
