...
const team = [
  ...
  },
  {
    ...
    photo: genericPhoto,
    description:
      "Senior engineer with experience with language runtimes. He previously worked in Oracle-Labs in the Truffle framework, accelerating the execution of the Ruby.",
    github: "bjfish"
  },
  {
    name: "Heyang Zhou",
...
const Home = () => (
  <div>
    ...
    <div className={css.hero}>
      ...
      <p>
        Wasmer was founded to solve problems we faced ourselves every day. Now,
        we strive to contribute to developers and companies around the world
        reaching their full potential and we do it with a smile.
      </p>
      <p>
        Our team is distributed but connected by a culture of diligence,
        amplified by passion rather than pressure. We don’t blame, we stay kind
        and value each other in good and in not so good times.
      </p>
    </div>
